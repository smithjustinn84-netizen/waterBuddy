...
class GetHydrationInsightsUseCaseTest {
    ...
    @Test
    fun `invoke returns insights based on repository stats`() =
        runTest {
    ...
    @Test
    fun `calculateLongestStreak handles multiple streaks and identifies max`() =
        runTest {
            val today = Clock.System.todayIn(TimeZone.currentSystemDefault())
    ...
    @Test
    fun `weeklyTrend and monthlyTrend are correctly filtered and sorted`() =
        runTest {
            val today = Clock.System.todayIn(TimeZone.currentSystemDefault())
    ...
    @Test
    fun `empty stats returns default insights with zero values`() =
        runTest {
